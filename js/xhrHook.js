    ...
    return (`
      ...
      function Proxy(proxy) {
        ...
        function handleResponse(xhr, xhrProxy) {
          ...
          var ret = {
            ...
            config: xhr.config,
            headers: xhr.resHeader || xhr.getAllResponseHeaders().split('$rn$').reduce(function (ob, str) {
              if (str === "") return ob;
              var m = str.split(":");
      ...
      proxy({
        ...
        onResponse: (response, handler) => {
          ...
          localStorage.setItem('test', JSON.stringify(JSON.parse(response.response)));
